  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1400px] mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.scope} onChange={(e) => handleScopeChange(e.target.value)}
                  className="w-full mt-1 px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none">
              ...
              <div>
                ...
                <select value={form.category} onChange={(e) => handleCategoryChange(e.target.value)}
                  disabled={!form.scope}
                  className={`w-full mt-1 px-3 py-2 border rounded-lg text-sm outline-none transition-colors ${!form.scope ? "border-border bg-muted/50 text-muted-foreground cursor-not-allowed" : "border-border focus:ring-2 focus:ring-primary/30 focus:border-primary"}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.source} onChange={(e) => handleSourceChange(e.target.value)}
                  ...
                  className={`w-full mt-1 px-3 py-2 border rounded-lg text-sm outline-none transition-colors ${!form.category ? "border-border bg-muted/50 text-muted-foreground cursor-not-allowed" : "border-border focus:ring-2 focus:ring-primary/30 focus:border-primary"}`}>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <select value={scopeFilter} onChange={(e) => { setScopeFilter(e.target.value); setCategoryFilter("all"); }} className="h-8 px-3 text-xs border border-border rounded-lg">
